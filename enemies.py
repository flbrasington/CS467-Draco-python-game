...
class ghost(Enemy):
    ...
    def __init__(self, walkingImages, speedX, speedY):
        Enemy.__init__(self, walkingImages, None, 0, speedX, speedY)
...
class SnowMan(Enemy):
    ...
    def __init__(self, attackingImages):
        #calls the parent's constructor
        Enemy.__init__(self, None, attackingImages, 0, 0, 0)
...
'''
class Yeti(Enemy):
    def __init__(self, walkingImages):
        # for now the walking images and attacking images are the same
        Enemy.__init__(self, walkingImages, walkingImages, 100, 2, 0)
...
class green_snake(Enemy):
    ...
    def __init__(self, walkingImages, attackingImages, attackDist, speedX):
        Enemy.__init__(self, walkingImages, attackingImages, attackDist, speedX, 0)
