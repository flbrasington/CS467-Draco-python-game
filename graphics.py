...
TILEDICT = {'ice block': pygame.image.load('Graphics/tiles/iceBlock.png'),
			...
			'snow plat left': pygame.image.load('Graphics/tiles/snow_plat_left.png').convert_alpha(),
			'snow plat right': pygame.image.load('Graphics/tiles/snow_plat_right.png').convert_alpha(),
			'snow round top': pygame.image.load('Graphics/tiles/snow_plat_round_top.png').convert_alpha(),
			'snow top left': pygame.image.load('Graphics/tiles/snow_top_left.png').convert_alpha(),
			'snow top right': pygame.image.load('Graphics/tiles/snow_top_right.png').convert_alpha(),
			...
			'dirt plat right': pygame.image.load('Graphics/tiles/dirt_plat_right.png').convert_alpha(),
			'dirt plat left': pygame.image.load('Graphics/tiles/dirt_plat_left.png').convert_alpha(),
			'dirt round top': pygame.image.load('Graphics/tiles/dirt_plat_round_top.png').convert_alpha(),
			'dirt top left': pygame.image.load('Graphics/tiles/dirt_top_left.png').convert_alpha(),
			'dirt top right': pygame.image.load('Graphics/tiles/dirt_top_right.png').convert_alpha(),
			...
			'castle plat left': pygame.image.load('Graphics/tiles/castle_plat_left.png').convert_alpha(),
			'castle plat right': pygame.image.load('Graphics/tiles/castle_plat_right.png').convert_alpha(),
			'castle round top': pygame.image.load('Graphics/tiles/castle_plat_round_top.png').convert_alpha(),
			'castle top left': pygame.image.load('Graphics/tiles/castle_top_left.png').convert_alpha(),
			'castle top right': pygame.image.load('Graphics/tiles/castle_top_right.png').convert_alpha(),
