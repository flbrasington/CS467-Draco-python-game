...
class Level:
    ...
    def __init__(self, numRow, numCol, screen_width, screen_height, player):
        ...
        self.room_side_length_x = screen_width / numCol
        self.room_side_length_y = screen_height / numRow
        ...
        self.blocks_per_room_x = 10
        self.blocks_per_room_y = 8
...
def main():
    ...
    level_list = []
    level_list.append(Level(5, 5, constants.SCREEN_WIDTH, constants.SCREEN_HEIGHT, p))
    ...
    p.rect.x = current_level.start_room['column'] * current_level.room_side_length_x
    p.rect.y = constants.SCREEN_HEIGHT - p.rect.height - 30
